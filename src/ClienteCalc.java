...
// y permite al usuario perar con un menú interactivo.
public class ClienteCalc {
    
    public static void main(String[] args) {
        try{
            // PASO 1: Concetarse al Registry del servidor.
            // "localhost" = misma maquina. Cambiar por IP real si está en otra máquina.
            Registry registry = LocateRegistry.getRegistry("localhost",1099);

            // PASO 2: Obtener el objeto remoto por su nombre clave.
            // lookup() retoruna un Stub (proxy) que intercepta cada llamada.
                ...
                if (opcion >= 1 && opcion <= 4){
                    ...
                    switch (opcion) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            // División: captura la excepcion si el usuario intenta dividir entre cero
                            try{
